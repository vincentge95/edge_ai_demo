async function handleEvent(event) {
  ...
  let area = body["area"];
  let prompt = hair_color + "," + eye_color + "," + area + ",portrait photo of a pretty young lady, rich skin texture, ID photo, front view, chest up, medium shot, clear background, rich details, real, high resolution, extremely high quality, detailed background, excellent details and textures, detailed skin, detailed eyes, 8k UHD";
